...
//    } else return false
      ...
      PWM_CASE(3, A);
// case TIMER3A:   // Port E bit 3
//    if (TCCR3A & (_BV(COM3A1) | _BV(COM3A0))) {
//      PWM_PRINT(OCR3A); >>>--->                      
//      do{ sprintf_P(buffer, PSTR("PWM:  %4d"), OCR3A); SERIAL_ECHO(buffer); }while(0)
//
//PWM: 1001 1100   0100 0000   (-25536)
//
//TCCR3A:0  TCCR3B:2  TIMSK3:2   CS:2   COM3A:0  WGM:0    non-standard PWM mode
