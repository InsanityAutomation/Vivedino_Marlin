...
#ifndef MOTHERBOARD
  #define MOTHERBOARD  BOARD_FORMBOT_TREX3//34//BOARD_RUMBA
#endif
...
#define  FILAMENT_CHANGE_FEATURE
  ...
  #define FILAMENT_CHANGE_X_POS 3             // 暂停X移动的距离
  #define FILAMENT_CHANGE_Y_POS 3             // 暂停Y移动的距离
  #define FILAMENT_CHANGE_Z_ADD 10            // 暂停升高Z的距离
  #define FILAMENT_CHANGE_XY_FEEDRATE 100     // 暂停XY移动的速度
  #define FILAMENT_CHANGE_Z_FEEDRATE 5        // 暂停Z移动的速度
  #define FILAMENT_CHANGE_RETRACT_FEEDRATE 60 // 暂停挤出机回抽速度
  #define FILAMENT_CHANGE_RETRACT_LENGTH 2    // 暂停挤出机回抽长度
  
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 10  // 自动卸载材料的速度
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 100   // 自动卸载材料的长度
  
  #define FILAMENT_CHANGE_LOAD_FEEDRATE  1     // 自动装载材料的速度
  #define FILAMENT_CHANGE_LOAD_LENGTH   100    // 自动装载材料的长度
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_INSET_X 3          // Mesh inset margin on print area
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT ((400) / 2)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT ((400) / 2)    // Y point for Z homing when homing all axis (G28).
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (150), (Y_MIN_POS + 20), 20 }
#endif
